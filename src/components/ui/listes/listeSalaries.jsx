        ...
        <div className='w-full overflow-x-scroll'>
            <table className='w-full border-separate border-spacing-y-2'>
                <thead className='bg-whiteColor'>
                    ...
                    <th className='py-4 text-center text-blackColor font-semibold text-sm '>{t("Salaire")}</th>
                    <th className='py-4 text-center text-blackColor font-semibold text-sm '>{t("Banque")}</th>
                    <th className='py-4 text-center text-blackColor font-semibold text-sm '>{t("N Compte")}</th>
                ...
                <tbody className=''>
                    ...
                    <tr key={e.id} className='bg-whiteColor'>
                        <td className='py-4 min-w-[300px] text-center text-textGreyColor font-medium text-sm rounded-lg'>{e.nom_salarie}</td>
                        <td className='py-4 min-w-[200px] text-center text-textGreyColor font-medium text-sm '>{e.nni}</td>
                        <td className='py-4 min-w-[100px] text-center text-textGreyColor font-medium text-sm '>{e.salaire}</td>
                        <td className='py-4 min-w-[100px] text-center text-textGreyColor font-medium text-sm '>{e.banque.code_banque}</td>
