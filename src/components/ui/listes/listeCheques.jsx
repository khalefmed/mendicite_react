            ...
            <table className='w-full border-separate border-spacing-y-2'>
                ...
                <tbody className=''>
                    ...
                    <tr key={e.id} className='bg-whiteColor'>
                        <td className='py-4 min-w-[100px] text-center text-textGreyColor font-medium text-sm rounded-lg'>{e.numero_cheque}</td>
                        <td className='py-4 min-w-[200px] text-center text-textGreyColor font-medium text-sm '>{e.nom_cheque}</td>
