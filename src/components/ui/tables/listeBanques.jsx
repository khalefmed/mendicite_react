            ...
            <table className='w-full border-separate border-spacing-y-2'>
                ...
                <tbody className=''>
                    ...
                    <tr key={e.id} className='bg-whiteColor'>
                        <td className='py-4 text-center text-textGreyColor font-normal text-xs rounded-lg'>{e.code_banque}</td>
                        <td className='py-4 text-center text-textGreyColor font-normal text-xs '>{e.nom_banque}</td>
