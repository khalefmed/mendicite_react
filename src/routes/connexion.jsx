            ...
            <form className="lg:w-[40%] flex flex-col px-8 py-16 items-center justify-center align-center gap-8 ">
              ...
              <div className="flex flex-col gap-3 w-full">
                <div className="flex flex-row gap-2 bg-bgGreyColor px-4 py-3 text-sm w-full font-light rounded-md">
                  <img src={Person} alt="" />
                  <input type="text" placeholder={t("Nom utilisateur")} name="nom_utilisateur" className="outline-none placeholder-inputTextColor bg-inherit" />
                </div>
                <div className="flex flex-row gap-2 bg-bgGreyColor px-4 py-3 text-sm w-full font-light rounded-md">
                  <div className="flex flex-row gap-2">
                    <img src={Password} alt="" />
                    <input type={show ? "text" : "password"} placeholder={t("Mot de passe")} name="password" className="outline-none placeholder-inputTextColor bg-inherit" />
                  </div>
